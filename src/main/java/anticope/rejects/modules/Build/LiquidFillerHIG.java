...
import anticope.rejects.utils.ListMode;
...
public class LiquidFillerHIG extends Module {
    ...
    public LiquidFillerHIG() {
        super(MeteorRejectsAddon.Build, "liquid-filler-HIG", "Places blocks inside of liquid source blocks within range of you.");
    }

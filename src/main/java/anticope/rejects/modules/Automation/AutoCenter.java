...
import static anticope.rejects.utils.HIGUtils.getHighway;
...
public class AutoCenter extends Module {
    ...
    public AutoCenter() {
        super(MeteorRejectsAddon.Automation, "auto-center", "Automatically centers the player so that HighwayBorers mine on axis.");
    }
